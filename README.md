...
📈 **Historisierung** — Letzte 100 Datenpunkte pro Sensor verfügbar
...
5. Füge hinzu: `https://git.pfeiffer-privat.de/HA-Addons/ElegantChart`
6. Kategorie: Frontend
7. Klicke "Erstellen"
8. Installiere "Elegant Chart Card"
...
# Oder mit SSH
git clone git@git.pfeiffer-privat.de:HA-Addons/ElegantChart.git
```
...
- Automatisches Buffer-Management (max. 100 Datenpunkte)
...
Issues und Feature Requests: https://git.pfeiffer-privat.de/HA-Addons/ElegantChart/issues
